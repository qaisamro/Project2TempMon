...
class PyBrowser(tk.Tk):
    def __init__(self):
        ...
        # URL Entry
        self.url_label = tk.Label(self, text="الرابط:")
        ...
        # Headers Entry
        self.headers_label = tk.Label(self, text="الرؤوس:")
    ...
    def display_response(self, response, cached=False):
        self.response_text.delete(1.0, tk.END)
        cache_status = " (من الذاكرة المؤقتة)" if cached else ""
        self.response_text.insert(tk.END, f"كود الحالة: {response.status_code}{cache_status}\n")
        self.response_text.insert(tk.END, "الرؤوس:\n")
