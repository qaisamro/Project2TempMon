...
class PyBrowser(tk.Tk):
    def __init__(self):
        ...
        style = ttk.Style()
        style.configure("TButton", foreground="black", background="red", font=("Helvetica", 12))
        style.configure("TEntry", foreground="black", background="red", font=("Helvetica", 12))
        style.configure("TLabel", foreground="black", background="red", font=("Helvetica", 12))
        style.configure("TCombobox", foreground="black", background="red", font=("Helvetica", 12))
